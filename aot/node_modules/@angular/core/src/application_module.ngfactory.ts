...
class ApplicationModuleInjector extends import0.NgModuleInjector<import1.ApplicationModule> {
  ...
  get _APP_ID_5():any {
    if ((this.__APP_ID_5 == null)) { (this.__APP_ID_5 = import7._appIdRandomProviderFactory()); }
    return this.__APP_ID_5;
  }
  get _ViewUtils_6():import5.ViewUtils {
    if ((this.__ViewUtils_6 == null)) { (this.__ViewUtils_6 = new import5.ViewUtils(this.parent.get(import8.RootRenderer),this.parent.get(import9.Sanitizer))); }
    return this.__ViewUtils_6;
  }
  get _IterableDiffers_7():any {
    if ((this.__IterableDiffers_7 == null)) { (this.__IterableDiffers_7 = import1._iterableDiffersFactory()); }
    return this.__IterableDiffers_7;
  }
  get _KeyValueDiffers_8():any {
    if ((this.__KeyValueDiffers_8 == null)) { (this.__KeyValueDiffers_8 = import1._keyValueDiffersFactory()); }
